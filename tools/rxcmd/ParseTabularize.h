//===-- ParseTabularize.h - Parse CLI params for Tabularize -----*- C++ -*-===//
//
...
#ifndef RXDOCK_TOOLS_RXCMD_PARSETABULARIZE_H
#define RXDOCK_TOOLS_RXCMD_PARSETABULARIZE_H

namespace rxdock {

int parseTabularize(int argc, char *argv[]);

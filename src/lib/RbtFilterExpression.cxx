...
FilterLogExp::FilterLogExp(RbtFilterExpressionPtr op1) : operand(op1) {
  _RBTOBJECTCOUNTER_CONSTR_(_CT);
}
...
FilterExpExp::FilterExpExp(RbtFilterExpressionPtr op1) : operand(op1) {
  _RBTOBJECTCOUNTER_CONSTR_(_CT);
}
...
FilterIfExp::FilterIfExp(RbtFilterExpressionPtr op1, RbtFilterExpressionPtr op2,

/***********************************************************************
* $Id: //depot/dev/client3/rdock/2006.1/src/lib/RbtTriposAtomType.cxx#3 $
...
RbtTriposAtomType::eType RbtTriposAtomType::operator() (RbtAtom* pAtom,RbtBool useExtendedTypes) const {
  ...
  case 6://C
    ...
    case RbtAtom::SP2:
      if (useExtendedTypes)
	switch (nImplH) {
	case 1: return C_2_H1;
	case 2: return C_2_H2;
	default:return C_2;
	}
      else
	return C_2;
    ...
    case RbtAtom::SP3:
      if (useExtendedTypes)
	switch (nImplH) {
	case 1: return C_3_H1;
	case 2: return C_3_H2;
	case 3: return C_3_H3;
	default:return C_3;
	}
      else
	return C_3;

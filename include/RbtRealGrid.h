...
public:
  ...
  RbtRealGrid(const RbtCoord &gridMin, const RbtCoord &gridStep, RbtUInt NX,
  ...
  RbtDouble GetValue(const RbtCoord &c) const {
  ...
  RbtDouble GetValue(RbtUInt iXYZ) const {
  ...
  void ReplaceValueRange(RbtDouble oldValMin, RbtDouble oldValMax,
                         RbtDouble newVal);
  ...
  void SetSphere(const RbtCoord &c, RbtDouble radius, RbtDouble val,
  ...
  void SetSurface(const RbtCoord &c, RbtDouble innerRad, RbtDouble outerRad,
                  RbtDouble val, RbtBool bOverwrite = true);
  ...
  RbtBool isValueWithinSphere(const RbtCoord &c, RbtDouble radius,
                              RbtDouble val);
  ...
  // newValue
  void SetAccessible(RbtDouble radius, RbtDouble oldVal, RbtDouble adjVal,
                     RbtDouble newVal, RbtBool bCenterOnly = true);
  ...
  RbtUInt Count(RbtDouble val) const {
...
private:
  ...
  void SetValues(const RbtUIntList &iXYZList, RbtDouble val,
                 RbtBool bOverwrite = true);

...
public:
  RbtFileError(const RbtString &strFile, RbtInt nLine,
...
public:
  RbtFileReadError(const RbtString &strFile, RbtInt nLine,
                   const RbtString &strMessage = "")
...
public:
  RbtFileWriteError(const RbtString &strFile, RbtInt nLine,
                    const RbtString &strMessage = "")
...
public:
  RbtFileParseError(const RbtString &strFile, RbtInt nLine,
                    const RbtString &strMessage = "")
...
public:
  RbtFileMissingParameter(const RbtString &strFile, RbtInt nLine,
                          const RbtString &strMessage = "")
...
public:
  RbtDirIsNotAccessible(const RbtString &strFile, RbtInt nLine,
                        const RbtString &strMessage = "")
...
public:
  RbtNoFileInDir(const RbtString &strFile, RbtInt nLine,
                 const RbtString &strMessage = "")
...
public:
  RbtEnvNotDefined(const RbtString &strFile, RbtInt nLine,
                   const RbtString &strMessage = "")
...
public:
  RbtStringTooLong(const RbtString &strFile, RbtInt nLine,
                   const RbtString &strMessage = "")
